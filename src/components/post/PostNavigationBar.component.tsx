...
const PostNavigationBar = ({
  ...
  if (nextPost) {
    ...
    nextPostURL = nextPost
      ? `/${targetCollection}/${nextSlug}`
      : ""
  }
  ...
  if (previousPost) {
    ...
    previousPostURL = previousPost
      ? `/${targetCollection}/${previousSlug}`
      : ""
  }
    ...
    >
      <div className="post-navigation-inner">
        ...
        >
          <>
            <FontAwesomeIcon
              icon={faArrowLeft}
            ></FontAwesomeIcon>
            <span className="label">Newer {itemName}</span>
          </>
        </Button>
        ...
        <Button
          ...
          classes={`padded right ${
            !hasPreviousPost && "unavailable"
          }`}
        >
          <>
            <span className="label">Older {itemName}</span>
            <FontAwesomeIcon
              icon={faArrowRight}
            ></FontAwesomeIcon>
          </>
