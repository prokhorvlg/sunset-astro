...
import { faPatreon, faDiscord, faRedditAlien, faTwitter, faInstagram } from "@fortawesome/free-brands-svg-icons"
import { faHome, faList, faGamepad, faImage } from "@fortawesome/free-solid-svg-icons"

export const SocialsSegment = ({ currentPage = '', isFooter = false }) => {
    return (
