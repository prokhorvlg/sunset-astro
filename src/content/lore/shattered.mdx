...
The behemoth then felt an indescribable loneliness, the kind one could only experience as the last of their product line, trapped in a world that was not their own.

OPCON had been changed forever, and could never return to the way it was before.
...
OPCON sheepishly began to reach back out to its external sensors. It was mildly annoyed with its navigator for interrupting, until it noticed that half of its cameras were disabled, and the others were staring into what looked like pure noise.

Oh, no... they were covered in snow.

Memories of reality came crashing back. A front was only three hundred miles to the northeast before, which, extrapolating, meant the storm would be *on top of them* by now. This was exactly what they've been trying to avoid.
...
The machines collectively attempted everything they could think of. Redirecting thruster exhaust at the joints: didn't seem to make a dent in the ice. An army of drones chipped away at frost, but not *quite* enough to make way. Overclocking the reactor would only cause the motors to burn out. All it needed was a *little push*...

<QuoteRow author={AuthorCrawlerNavigator} left none>
The ice is accumulating FASTER than your efforts to remove it. This unit will begin setting up the RECOVERY BEACON.
</QuoteRow>
...
Without any kind of preparation or warning, Aquila took flight. This wasn't anything like normal flight, this was *pure gravimetric manipulation*, the kind that humanity had barely cracked back when they vanished. In a stunning display of aerial acrobatics and impossible mobility, the machine silently drifted towards one of the behemoth's 300-ton legs and wrapped its delicate manipulators over a rung. It pulled against nothing bur turbulent air...

An ear-splitting roar boomed across the valley as the leg suddenly lifted out from under a mountain of snow. Ice within the joint snapped and shattered instantly, and an avalanche of frost burst out from within the structure to be carried away by gale.
...
Aquila stood on one of the rusted forward balconies of the behemoth's cabin, watching the sunshine reflect off the glossy aqua-cerulean photofungals of the alien forest as it scrolled past. The platform rattled with each step as the beast below slowly moved towards the west. The sky felt immense, clear and blue to the sea on the distant horizon. The storm was long over, and they were safe.

The robot sighed (electronically). This part never became easier.
...
You know, LONGSIGHT won't like this.
</QuoteRow>

Aquila and OPCON turned their attention to the navigator, who was brooding over several undesirable paths for the walker to take in the near future. It perked up when it caught mention of its designation, and a new symbol blinked onto the beige terminal closest to the machine of glass.
...
The navigator turned their attention to OPCON, implicitly begging for confirmation. The behemoth mastermind nodded, indicating they've already confirmed and evaluated the threat.
...
Aquila tapped their glass head, gesturing at an empty memory drive somewhere deep within.
