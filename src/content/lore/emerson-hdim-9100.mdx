...
/>
  ...
  The `Emerson HDIM` series is an example of the heaviest class of interface robots, systems designed to operate in human spaces and interact with human tools. The interface class also includes [GORDON](/posts/redmond-gordon), [ISAAC](/posts/maple-cybernetic-isaac), and the various BBM frames that have been depicted before.
