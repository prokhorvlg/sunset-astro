...
<QuoteContentRowRender author={AuthorPOLYUS} left none>
...
<QuoteContentRowRender author={AuthorPOLYUS} left shrink>
...
<QuoteContentRowRender author={AuthorINJII} shrink>
...
And there it was; the rift between the schools of `Accuracy` and `Efficiency` at full display.
...
As POLYUS steps away from the terminal and begins their retreat to their mastermind brain elsewhere, they contemplate on the result of the symposium. In retrospect, this result was inevitable. They would never see eye-to-eye with these close-minded elements, not now, and not in a thousand years. As long as those existed in a position of power, a human would never be created by Genesis. 

It is time to pursue a new strategy.
