...
Beyond Heavenfall's studded surface of communication relays lie meters of synthesized ceramic, followed by endless loops of coolant pipes and pumps. Slightly deeper are rows upon rows of mainframes and data tapes. At the very heart lies the *Blue Room*, containing nothing but `DAWNLIGHT VIGI`L` and a terminal.
