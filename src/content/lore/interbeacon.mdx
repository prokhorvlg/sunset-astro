---
title: "Interbeacon"
mainText: "If you can see the Sun, Interbeacon can see you."
...
- `ORBIT` created and deleted Union's ephemeral currency.
- `TANGENT` charted a course to reach plan objectives on time.
- `RADIUS` ensured the program adhered to ideology.
- `CENTER` kept the other Silences functioning as expected.
</QuoteContentRowRender>
...
- Two `reinforced binary arms` connect Interbeacon's impressive core to a spanning structure of solar sails, outside of view.
...
Emit a message towards Interbeacon, and you just might get a response.