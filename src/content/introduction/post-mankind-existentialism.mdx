...
## <span class="short"><i>title:</i>Anomalies lurk beyond each protocol<i>:</i></span> The Solar System is full of existential danger, as entities and anomalies lurk beyond each protocol.
...
<QuoteContentRowRender author={AuthorUniserve} >
Other ANOMALIES you should be aware of before you exit the station...
