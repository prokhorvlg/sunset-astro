...
One of these facilities is `Tiān Pharmaceutical`, a crewed outpost built in the 2020s to perform zero-g experimentation using live animals, likely to test various experimental acclimation drugs.
