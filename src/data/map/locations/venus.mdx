...
The largest settlement is `Vostok City`, built over the site of the Union's first colonization attempt. The city features the tallest artificial wall in the Solar System, an enormous concrete barrier created to protect the colonists from hostile wildlife. Eventually, hundreds of miles of land around Vostok were burned and "sanitized", allowing the population to branch out far beyond the dense, walled core of the city. A number of aerotrain lines extend from Vostok to the `Zvezda Cosmodrome` and `Institute of Agriculture` further south, but its notoriously high-status citizenry preferred hovercars, a developing technology at the time of the Unexpected Interrupt.
