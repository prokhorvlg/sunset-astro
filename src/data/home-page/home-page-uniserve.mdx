...
<QuoteContentRow author={AuthorUniserve} client:only >
    ...
    This unit is DELIGHTED that you have arrived here with minimal damage. Those YSH SHUTTLES were not designed to transport delicate electronics...    
</QuoteContentRow>
...
<QuoteContentRow author={AuthorUniserve} client:only none >
